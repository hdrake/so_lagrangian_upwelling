...
path2ice = '/archive/akm/CM2.6/CM2.6_A_Control-1860_V03/history/'
# U,V saved in 1 yr files at 5day resolution
path2files = '/archive/rds/CM2.6/CM2.6_A_Control-1860_V03/history/'
path2save = '/archive/hfd/CM2.6/CM2.6_A_Control-1860_V03/5day/for_CMS_SO/'
path2figures = '/work/hfd/figures/CM2.6/misc/'
figdir = path2figures
...
# Sw_ocean
data = nc.Dataset('/archive/wga/CM2.6/'+exp+'/pp/ocean/ts/monthly/5yr/ocean.018101-018512.wt.nc')
sw_ocean = data.variables['sw_ocean'][:]
xt_ocean = data.variables['xt_ocean'][:]
yt_ocean = data.variables['yt_ocean'][:index_north]
data = nc.Dataset('/archive/wga/CM2.6/'+exp+'/pp/ocean/ts/monthly/5yr/ocean.018101-018512.u.nc')
...
for file in files:
    ...
    for countu5day in range(0,73):
        ...
        if (countu5day == 0):
            ...
            file_name_prefix_before = str(year-1).zfill(4)+'0101.ocean_minibling_field_'
            ...
            file_name_prefix_after = str(year+1).zfill(4)+'0101.ocean_minibling_field_'
            data_before = data
