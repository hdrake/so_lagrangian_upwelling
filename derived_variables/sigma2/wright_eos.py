 ...
 ***********************************************************************
    ...
    Modified by A Morrison 8/14.

 Calculate seawater equation of state, given T[degC],S[PSU],
 	n[reference pressure / 1000 dB]
 Returns density anomaly [kg m-3]
 ...
 ***********************************************************************
 ...
 """
  ...
  I_denom = 1.0 / (lam + (a0 + a1*T +a2*S)*(p+p0))  
  rho = (p + p0) * I_denom - rho_ref
